...
function hendlerMessage(getjson) {
    ...
    if (key_from_html == "containers" || key_from_html == "create" ||
        key_from_html == "start" || key_from_html == "stop" || key_from_html == "remove") {
            $("#print_containers").empty();
        };
      ...
      case "containers":
         for (key in parsejson.result) {
             if (parsejson.result[key][1].indexOf("Up") == 0) {
                 $("#print_containers").append(
                    "<li>" + parsejson.result[key][0] +
                    "<br/>" + parsejson.result[key][1] +
                    "</li>" +
                 ...
                 $("#print_containers").append(
                     ...
                     "<button onclick='load(\"remove\", \"" + parsejson.result[key][0] +
